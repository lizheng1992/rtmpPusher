...
JNIEXPORT void JNICALL Java_com_lizheng_live_jni_PusherNative_setVideoOptions(
...
JNIEXPORT void JNICALL Java_com_lizheng_live_jni_PusherNative_setAudioOptions(
...
JNIEXPORT void JNICALL Java_com_jutong_live_jni_PusherNative_startPusher(
...
JNIEXPORT void JNICALL Java_com_jutong_live_jni_PusherNative_fireAudio(
...
JNIEXPORT jint JNICALL Java_com_lizheng_live_jni_PusherNative_getInputSamples() {
    return nInputSamples;
}

JNIEXPORT void JNICALL Java_com_jutong_live_jni_PusherNative_fireVideo(
...
JNIEXPORT void JNICALL Java_com_lizheng_live_jni_PusherNative_stopPusher(
...
JNIEXPORT void JNICALL Java_com_lizheng_live_jni_PusherNative_release(
        JNIEnv *env, jobject thiz) {
    Java_com_lizheng_live_jni_PusherNative_stopPusher(env, thiz);
    if (audioEncHandle) {
